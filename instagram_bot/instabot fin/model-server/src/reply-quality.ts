...
export const KAZAKH_QUALITY_FALLBACK: Record<Surface, string> = {
  comment:
    "Сәлеметсіз бе! Депозит ашу шарттарын hcsbk.kz сайтынан немесе 1432 байланыс орталығынан нақтылаған дұрыс.",
  dm: "Сәлеметсіз бе! Депозитті Otbasy bank мобильді қосымшасында, hcsbk.kz сайтында немесе банк бөлімшесінде ашуға болады. Нақты шарттар мен ай сайынғы жарнаны 1432 байланыс орталығынан нақтылаған дұрыс.",
};
